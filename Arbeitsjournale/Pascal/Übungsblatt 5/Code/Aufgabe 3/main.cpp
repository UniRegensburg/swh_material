...
/*Other*/
#define MAX_TIME_PERIOD 10000
#define MIN_TIME_PERIOD 1000
#define REACTION_TIME 1000
#define MAX_SCORE 5

Adafruit_NeoPixel strip(MAX_SCORE, LED_STRIP_PIN, NEO_GRB + NEO_KHZ800); // LED strip
...
int win_melody[] = {NOTE_C4, NOTE_G3, NOTE_G3, NOTE_A3, NOTE_G3, 0, NOTE_B3, NOTE_C4};
